...
namespace _20_MvcCoreUtilidades.Helpers
{
    public class HelperCryptography
    {
        ...
        {
            //NECESITAMOS TRABAJAR A NIVEL DE BYTE[]. DEBEMOS CONVERTIR EL TEXTO RECIBIDO A BYTE[]
            byte[] entrada;

            //UNA VEZ CONVERTIDO EL CIFRADO NOS DEVUELVE UN BYTE[] DE SALIDA
            byte[] salida;

            //NECESITAMOS UN CONVERSOR PARA CONVERTIR STRING A BYTE[] Y VICEVERSA
            UnicodeEncoding encoding = new UnicodeEncoding();

            //NECESITAMOS UN OBJETO PARA EL CIFRADO
            SHA1Managed sHA1 = new SHA1Managed();

            //CONVERTIMOS EL OBJETO DE STRING A BYTE[]
            entrada = encoding.GetBytes(contenido);

            //EL OBJETO SHA1 RECIBE UN ARRAY DE BYTES E INTERNAMENTE HACE "ALGO" PARA DEVOLVER OTRO ARRAY DE BYTES
